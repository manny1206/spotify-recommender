    ...
    for index in range(50):
        ...
        try:
            ...
            if (temp_track is None):
                ...
                song_features["popularity"] = temp_track["popularity"]
...
# gets the top 12 most similar songs
def recommend(dataset, user_top_songs):
    ...
    recommended_ids = list(distances.keys())[:12]
...
# main is only for building a new dataset or testing!
def main():
    start = time.time()
    print("Start")
